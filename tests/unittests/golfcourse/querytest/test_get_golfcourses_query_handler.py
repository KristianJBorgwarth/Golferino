...
class TestGetGolfcoursesQueryHandler(unittest.TestCase):
    ...
    @patch('core.features.golfcourse.queries.get.get_golfcourses_query_serializer.GetGolfcoursesQuerySerializer.is_valid',
           return_value=True)
    @patch('core.features.golfcourse.queries.get.get_golfcourses_query_serializer.GetGolfcoursesQuerySerializer.errors',
